/**********************************************************************************************
*
*   rcore_sdl - Functions to manage window, graphics device and inputs
*
...
{
    TRACELOG(LOG_WARNING, "ToggleFullscreen() is not supported on PLATFORM_WII_SDL");
}

// Toggle borderless windowed mode
void ToggleBorderlessWindowed(void)
{
    TRACELOG(LOG_WARNING, "ToggleBorderlessWindowed() is not supported on PLATFORM_WII_SDL");
}

// Set window state: maximized, if resizable
void MaximizeWindow(void)
{
    TRACELOG(LOG_WARNING, "MaximizeWindow() is not supported on PLATFORM_WII_SDL");
}

// Set window state: minimized
void MinimizeWindow(void)
{
    TRACELOG(LOG_WARNING, "MinimizeWindow() is not supported on PLATFORM_WII_SDL");
}

// Set window state: not minimized/maximized
void RestoreWindow(void)
{
    TRACELOG(LOG_WARNING, "RestoreWindow() is not supported on PLATFORM_WII_SDL");
}
